...
void main() {
  test('local backup restores profiles settings questions bookmarks and progress', () async {
    ...
    expect(
      controller.questions.any((Question item) => item.id == customQuestion.id),
      isTrue,
    );
