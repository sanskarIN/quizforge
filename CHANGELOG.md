...
- Domain, codec, deterministic fuzz-style, database integration, widget, accessibility, private-room, and primary quiz-journey tests.
...
- Local quality scripts now resolve dependencies, generate localizations, check formatting across `lib`, `test`, and `tool`, analyze, and run tests with coverage.
- Tagged releases regenerate localizations and verify formatting, analysis, and tests before Android/Web artifacts and checksums are published.
...
- Setup, development, testing, CI, release, roadmap, and screenshot documentation were synchronized with the current repository behavior.
...
- A queued or pending workflow is not treated as a successful verification result.
